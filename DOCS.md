...
* And more...<br />
See [utils.js](https://github.com/Gtajisan/Goat-Bot-business/blob/main/utils.js) for more details.
...
- Knowledge of [Facebook Chat API Unofficial](https://github.com/Gtajisan/fca-gtajisan/blob/master/DOCS.md)
...
#### Type: You can choose one of the following storage methods, config at [config.json](https://github.com/Gtajisan/Goat-Bot-business/blob/main/config.json)
...
<details>
	...
	<i>see more details at <a href="https://github.com/Gtajisan/Goat-Bot-business/blob/main/database/controller/usersData.js">usersData.js</a></i>
	<br />
	<br />
...
<details>
	...
	<i>see more details at <a href="https://github.com/Gtajisan/Goat-Bot-business/blob/main/database/controller/threadsData.js">threadsData.js</a></i>
	<br />
	<br />
 ...
 * Và kiến thức về api không chính thức của facebook như api.sendMessage, api.changeNickname,... bạn có thể tìm hiểu thêm tại đây: https://github.com/Gtajisan/fca-gtajisan/blob/master/DOCS.md
 ...
 * And knowledge of unofficial facebook api such as api.sendMessage, api.changeNickname,... you can learn more at here: https://github.com/Gtajisan/fca-gtajisan/blob/master/DOCS.md
...
* Reference from available commands: [cmds](https://github.com/Gtajisan/Goat-Bot-business/tree/main/scripts/cmds) and [events](https://github.com/Gtajisan/Goat-Bot-business/tree/main/scripts/events)
* See example at for command [here](https://github.com/Gtajisan/Goat-Bot-business/blob/main/scripts/cmds/newcommand.eg.js), for event [here](https://github.com/Gtajisan/Goat-Bot-business/blob/main/scripts/events/newcommandevent.eg.js)
